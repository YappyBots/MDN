...
class Client extends DiscordClient {
  ...
  runCommand(msg) {
    ...
    if (msg.guild && msg.guild.id === "260202843686830080" && !channelName.includes("support") && !channelName.includes("documentation") && !channelName.includes("testing")) return;
    ...
    if (cmd) {
      ...
      try {
        ...
        msg.channel.send(`:x: An error occurred! You should not see this. \`${e.message || e}\``);
        this.emit("error", e);
      }
    }
